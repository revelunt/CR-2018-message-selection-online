...
print01Report(mydata, modelname ="init2.txt")
...
myalgorithm <- sienaAlgorithmCreate(useStdInits = T, projname = "test.June12-MacPro.txt", diagonalize = 0,
...
myeff <- includeEffects(myeff, gwespBB, gwespBF, cycle3, inPop, outAct)
...
myeff <- includeEffects(myeff, name = "cand.pref.thermo",
                        avSim, interaction1 = "discussion.net")
